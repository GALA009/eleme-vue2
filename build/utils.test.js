...
describe("utils.cssLoaders", () => {
    test("0", () => {
        let callFunction = () => {
            utils.cssLoaders({ sourceMap: false, usePostCSS: false, extract: "George" })
        }
    ...
    test("1", () => {
        let callFunction = () => {
            utils.cssLoaders({ sourceMap: true, usePostCSS: false, extract: "Pierre Edouard" })
        }
    ...
    test("4", () => {
        let callFunction = () => {
            utils.cssLoaders({ sourceMap: true, usePostCSS: true, extract: "Edmond" })
        }
